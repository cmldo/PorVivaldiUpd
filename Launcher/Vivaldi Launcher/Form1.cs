...
namespace vivaldi_Launcher
{
    public partial class Form1 : Form 
    {
        ...
        private void Button1_Click(object sender, System.EventArgs e)
        {
            ...
            {
                System.IO.File.WriteAllText(applicationPath + "\\Vivaldi\\Profile.txt", "--user-data-dir=\"profile\"");
                this.Close();
            }
            if (radioButton2.Checked)
            {
                System.IO.File.WriteAllText(applicationPath + "\\Vivaldi\\Profile.txt", "--user-data-dir=\"Vivaldi\\profile\"");
                this.Close();
            }
            if (radioButton3.Checked)
            {
                System.IO.File.WriteAllText(applicationPath + "\\Vivaldi\\Profile.txt", "");
                this.Close();
            }
        }
    }
