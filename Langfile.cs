            ...
            switch (culture1.TwoLetterISOLanguageName)
            {
                case "ru":
                    switch (langText)
                    {
                        ...
                        case "MeassageRunning":
                            return "Необходимо закрыть Google Vivaldi перед обновлением.";
                        case "Register":
                            return "регистр";
                        case "Remove":
                            return "Удалить";
                        ...
                        case "AppDescriptFull":
                            return "Google Vivaldi – это быстрый и удобный браузер для работы с веб-страницами и приложениями. Он надежен и прост в использовании. Вы можете просматривать страницы в Интернете, положившись на систему защиту от вредоносного ПО и фишинга, которая уже встроена в Google Vivaldi.";
                ...
                case "de":
                    switch (langText)
                    {
                        ...
                        case "MeassageRunning":
                            return "Bitte schließen Sie den laufenden Google vivaldibrowser, bevor Sie den Browser aktualisieren.";
                        case "Register":
                            return "Registrieren";
                        case "Remove":
                            return "Entfernen";
                        ...
                        case "AppDescriptFull":
                            return "Google Vivaldi ist ein Webbrowser, der Webseiten und Apps in Sekundenschnelle lädt und dabei äußerst stabil und nutzerfreundlich ist. Dank des integrierten Malware- und Phishing-Schutzes können Sie bedenkenlos im Internet surfen.";
                        case "AppDescriptShort":
                ...
                default:
                    switch (langText)
                    {
                        ...
                        case "MeassageRunning":
                            return "Please close the running Google Vivaldi before updating the browser.";
                        case "Register":
                            return "Register";
                        case "Remove":
                            return "Remove";
                        ...
                        case "VInfo":
                            return "Version Info";
                        case "AppDescriptFull":
                            return "Google Vivaldi is a web browser that runs webpages and applications with lightning speed. It's fast, stable, and easy to use. Browse the web more safely with malware and phishing protection built into Google Vivaldi.";
                        case "AppDescriptShort":
